  ...
  return (
    ...
    >
        ...
        >
          <span
            ...
            style={{
              ...
              boxShadow: business.unavailable
                ? "none"
                : `0 0 6px ${statusColor}`,
            }}
          />
      ...
      <div className="px-4 pb-4 -mt-7 relative">
        ...
        <h2
          className="text-base font-black mb-0 leading-tight"
        ...
        {business.description && (
          <p
            className="text-xs leading-relaxed line-clamp-2 mb-3 mt-0.5"
